function doPost(e) {
  ...
  function createGoogleForm(data) {
    ...
    form.setDescription("Студенческая оценка преподавания — это ключевой механизм обратной связи об учебном процессе. Опрос анонимный.");
